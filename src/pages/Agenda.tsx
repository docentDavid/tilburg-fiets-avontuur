        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto">
            <div className="text-center mb-12">
              <h1 className="text-3xl md:text-4xl font-bold mb-4 text-gray-900">Ritten Agenda</h1>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Bekijk alle geplande ritten en schrijf je in. Voor elk niveau en elke afstand hebben we een geschikte tocht.
              </p>
            </div>
            ...
            {isLoading ? (
              ...
              <div className="text-center py-12">
                <p className="text-red-500">Er is een fout opgetreden bij het laden van de ritten.</p>
              ...
              <>
                            ...
                            <TableRow key={ride.id}>
                              ...
                              <TableCell>
                                <span className={`px-2 py-1 rounded-full text-xs ${
                                  ride.level === 'Uitdagend' ? 'bg-orange-100 text-orange-700' : 
                                  ride.level === 'Gemiddeld' ? 'bg-blue-100 text-blue-700' : 
                                  'bg-green-100 text-green-700'
                                }`}>
                                  {ride.level}
                                </span>
                              </TableCell>
                              <TableCell>{ride.participants}/{ride.max_participants}</TableCell>
                ...
                <div className="md:hidden grid grid-cols-1 gap-6 mb-12">
                  {rides?.map((ride) => (
                    <Card key={ride.id} className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                      <CardHeader className="pb-2">
                        <div className="flex justify-between items-start">
                          <CardTitle className="text-xl font-bold text-gray-900">{ride.title}</CardTitle>
                      ...
                      <CardFooter className="flex justify-between items-center pt-2">
                        <div className="text-sm text-gray-600">
                          <span className="font-medium">{ride.participants}/{ride.max_participants}</span> deelnemers
                        </div>
                        <Button className="bg-cycling-blue hover:bg-blue-600">
                          Inschrijven
                        </Button>
